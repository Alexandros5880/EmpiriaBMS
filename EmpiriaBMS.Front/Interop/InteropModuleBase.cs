...
namespace EmpiriaBMS.Front.Interop;
...
public abstract class InteropModuleBase
{
    ...
    protected virtual async Task<IJSObjectReference> ImportModuleAsync()
    {
        if (_module == null)
        {
            //var url = "https://unpkg.com/@microsoft/teams-js@2.7.1/dist/MicrosoftTeams.min.js";
            var url = "/js/MicrosoftTeams.min.js";
            _ = await ImportPrerequisiteModuleAsync(url);
