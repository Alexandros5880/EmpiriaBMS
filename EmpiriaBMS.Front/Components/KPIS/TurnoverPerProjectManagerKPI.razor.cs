...
public partial class TurnoverPerProjectManagerKPI : IKpiCompoment
{
    [Parameter]
    ...
    public string Title => "Turnover per Project Manager";
    ...
    {
        var dict = await _dataProvider.KPIS.GetTurnoverPerProjectManager(StartDate?.Date, EndDate?.Date);
    ...
    private void _initilizeChart(out PolarAreaConfig chart, bool displayLegend = false)
    {
        ...
        var dataset = new PolarAreaDataset<double>(values)
        {
