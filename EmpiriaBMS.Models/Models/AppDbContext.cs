...
public class AppDbContext : DbContext
{
    ...
    const string azure_staging_DB = "Data Source=tcp:embiriabms-staging.database.windows.net,1433;Initial Catalog=empiriabms-staging;User Id=admin-user;Password=!@%369gsdgl^%78n";
