...
public class AppDbContext : DbContext
{
    ...
    const string azureDB = "Data Source=tcp:empiriabms.database.windows.net,1433;Initial Catalog=EmpiriaBMS;User Id=db_a8c181_empiriabms_admin;Password=admin1234567";
