...
public class AppDbContext : DbContext
{
    ...
    const string localContainerDB = "Data Source=db,1433;Initial Catalog=empiriabms;User Id=sa;Password=-Plata123456";
    ...
    {
        optionsBuilder.UseSqlServer(localContainerDB);
